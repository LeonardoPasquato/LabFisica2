...
\begin{document}
    ...
    \section{Conclusione}
    Possiamo notare nel primo esperimento che i punti reali presi in laboratorio si sovrappongono quasi perfettamente al diagramma di Bode teorico.\par
    Mentre nel secondo esperimento abbiamo che i primi 2 casi sono sottosmorzati mentre il terzo è l'unico sovrasmorzato.

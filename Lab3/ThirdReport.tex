...
\title{\huge Relazione terza esperienza di laboratorio Fisica 2}
...
\begin{document}
    ...
    Lo scopo della terza esperienza di laboratorio è stato di studiare, costruire dei circuiti RLC
    (quindi un circuito che ha al suo interno resistenze conduttori e capacitori) e studiare la loro 
    risposta a diverse frequenze e forma d'onda. \par
    Saranno poi le misurazioni sperimentali ad essere messe a confronto con quelli teorici per valutare e discutere le possibili incongurenze che potrebbero apparire.\par   
    ...
    Nella seconda parte invece si esaminerà come la forma funzionale della risposta del circuito varia in funzione di L e C(in
    ...
    Secondo esperimento (valori di tensione dei picchi, tranne nel caso $c$ in cui non sono presenti picchi): \par
    \begin{tabular}{c l}
        $a$: & $R=10k\Omega$ \\
        & $L=500mH$ \\
        & $C=1nF$ \\
    ...
    \begin{minipage}{.4\linewidth}
        ...
        Legenda: \par
        \begin{itemize}
            \color{blue} \item  Grafico teorico di Bode;
            \color{red} \item Valori sperimentali di ampiezza;
            \color{green} \item Valori sperimentali di sfasamento.
        \end{itemize}
    \end{minipage}
    ...
    \begin{minipage}{.4\linewidth}
        ...
        \par
        \hspace{0.5 cm} \begin{itemize}
            \color{blue} \item $V_R(t) = Ae^{-\alpha t} cos(\omega_d t + \phi)$;
            \color{red} \item inviluppo teorico = $e^{-\alpha t}$;
            \color{green} \item valori sperimentali di tensione misurati nei picchi.
        \end{itemize}

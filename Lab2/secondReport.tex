...
\begin{document}
    ...
    Considerando quindi la differenza di potenziale e il tempo come un set di dati sperimentali y e x costituito da n campioni ciascuno, 
    quindi si ha $y=a \cdot e^{-\frac{x}{\tau}}$ \par
    Ora applicando il logaritmo naturale ad entrambi i membri si linearizza l'andamento e si ottiene $ln(y)=ln(a)-{\frac{x}{\tau}}$. \par
    ...
    presentati i parametri di un'onda (ampiezza, frequenza, fase, offset) e il metodo per modularli dal generatore.\par
    ...
    Poichè nella realtà un impulso non è replicabile, l'ingresso impulsivo è stato concretizzato in un'onda quadra, di cui
    è stata modulata 3 volte la durata.    
    ...
    Il capacitore del circuito RC ha quindi un intervallo $d$ di tempo per caricarsi, per poi iniziare a scaricarsi.

...
\begin{document}
    ...
    \begin{equation}
        \begin{split}
            ...
            \\
            ln{V_0} = (ln{V})_medio - \frac{1}{\tau}\cdot t_{medio} = 0.7048 - (-1039.876741)\cdot952.10^{-6} = 1.69472419 \longrightarrow V_{0a} = 5.445V
        \end{split}
    \end{equation}
    %grafico b
    \begin{equation}
        \begin{split}
            ...
            \\
            ln{V_0} = (ln{V})_medio - \frac{1}{\tau}\cdot t_{medio} = 0.0769 - (-9435.820)\cdot158^{-6} = 1.567717 \longrightarrow V_{0b} = 4.7957V
        \end{split}
    \end{equation}
    %grafico c
    \begin{equation}
        \begin{split}
            ...
            \\
            ln{V_0} = (ln{V})_medio - \frac{1}{\tau}\cdot t_{medio} = 0.5146 - (-1183.529)\cdot756^{-6} = 1.40937 \longrightarrow V_{0c} = 4.09337V
        \end{split}
    \end{equation}
    \end{center}

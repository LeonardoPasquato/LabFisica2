...
\begin{document}
    ...
    Lo scopo della prima esperienza di laboratorio è stato quello di proiettare su un piano reale ciò che è stato
    ...
    Lo scopo più implicito di questa esperienza è stato quello di familiarizzare con gli strumenti del laboratorio come il generatore da banco,
    ...
    \begin{align*}
       ...
       & \hspace{0.55cm} = \frac{\frac{8V}{1k\Omega} + \frac{5V}{1k\Omega} + \frac{-3V}{1k\Omega}}{\frac{1}{1k\Omega} + \frac{1}{1k\Omega} + \frac{1}{1k\Omega} + \frac{1}{10k\Omega}} = \\
       & \hspace{0.57cm} = 3,226V
    \end{align*}
    ...
    \begin{equation}
        \frac{V_out}{V_in} = \frac{R_{eqV}}{R_1 + R_{eqV}} = \frac{6V}{2V} = \frac{1}{3} \longrightarrow R_{eqV} = \frac{R_1}{2} = \frac{10M\Omega}{2} = 5M\Omega
    \end{equation}
